...
@property (nonatomic, assign) NSInteger runningSportId;//该活动关联的项目的ID
...
@property (nonatomic, assign) NSTimeInterval endedAt;//活动结束时间,时间戳格式(毫秒)
@property (nonatomic, assign) NSInteger kcalConsumed;//本次活动的卡路里消耗量
@property (nonatomic, assign) BOOL qualified;//本次活动是否达标
@property (nonatomic, strong) RunningSportModel *runningSport;//该活动所属的运动项目
